            ...
            {view === "login" && (
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <Button type="button" variant="outline" disabled={loading} onClick={() => handleOAuth("google")} className="font-bold">
                  ...
                  <Button type="button" variant="outline" disabled={loading} onClick={() => handleOAuth("apple")} className="font-bold">
            ...
            {view === "signup" && (
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <div className="relative my-1">
                  ...
                  <div className="relative flex justify-center text-[11px] uppercase"><span className="bg-background px-2 text-muted-foreground">or with email</span></div>
                </div>
                <div className="space-y-2">
