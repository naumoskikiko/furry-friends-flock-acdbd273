...
export const createUserLocationIcon = () =>
  L.divIcon({
    html: `<div style="position:relative;width:24px;height:24px;">
      <div style="position:absolute;inset:-6px;border-radius:50%;background:hsl(217,90%,60%);opacity:0.25;animation:user-loc-pulse 2s ease-out infinite;width:36px;height:36px;"></div>
